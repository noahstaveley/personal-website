$(function() {
    ...
    $(".typed").typed({
      strings: [
        ...
        "><span class='caret'>$</span> Do you want to use your coding skills to fight for trans people? Please reach out, I want to start an org (this is currently nothing more than an idea). <br/>"
      ],
      showCursor: true,
      cursorChar: '_',
      autoInsertCss: true,
